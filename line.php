  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อุณหภูมิตอนนี้")||($text == "อุณหภูมิวันนี้")||($text == "อุณหภูมิ")){
			...
			$reply_message = '"รายงานสถานการณ์ ยอดผู้ติดเชื้อไวรัสโคโรนา 2019 (COVID-19) ในประเทศไทย"ผู้ป่วยสะสม\nthereจำนวน  398,995  ราย\nthereผู้เสียชีวิต      จำนวน  17,365   ราย\nthereรักษาหาย      จำนวน  103,753  ราย\nthereผู้รายงานข้อมูล: นายปฏิภาณ ศรีทองคำ';
